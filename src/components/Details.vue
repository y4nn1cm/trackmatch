<template>
  <v-app>
    <div class="center">  
      ...
      <p class="body-2" style="text-align:jutify; color:rgb(21,149,135)">On this page we will ask you for some information. Based on your answers we are able to help reaching the goals you told us about.</p>
    ...
    <v-switch style="padding:0; margin-bottom:2vw" :label="`Our company is hiring`" v-model="helphiring"></v-switch>
      ...
      <v-text-field v-if="searchjob"
        name="company"
        label="Current employer (block visibility)"
        id="company"
        type="company"
        v-model="company"
        style="margin-top:0; border:0">
      ...
      <v-text-field v-if="helphiring"
        name="worklove"
        label="Why should I join your company?"
        id="worklove"
        type="worklove"
        v-model="worklove"
        style="margin-top:0; border:0"
      ...
      <v-text-field
        name="goal"
        label="Your summary (motivation, goals)"
        id="goal"
        type="goal"
        v-model="goal"
        style="margin-top:0; border:0"
    ...
    <p class="body-2">Business and Product</p>
      ...
      <v-btn v-if="checkReady()" class="teal" style="color:white" type="submit">save</v-btn>
